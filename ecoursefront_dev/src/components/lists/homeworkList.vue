<template>
  <div>
     <center><a-button-group>
       <a-button>全部作业</a-button>
       <a-button>已截至</a-button>
       </a-button-group></center>
    <a-button class="editable-add-btn" >+发布作业</a-button>
    <a-table bordered :dataSource="dataSource" :columns="columns">
      ...
      <template slot="operation" slot-scope="text, record">
        <div>
           <a type="text" :style="{color: '#2E8DEF'}">查看</a>
           <a-divider type="vertical" />
           <a type="text" :style="{color: '#2E8DEF'}">修改</a>
           <a-divider type="vertical" />
