...
<div :style="{ background: '#fff', padding: '0px',width:'600px',height:'900px',margin: '0px 0px 0px 0px',float:'left'}">
...
<div :style="{ background: '#fff', padding: '0px',width:'600px',height:'900px',margin: '0px 5px 0px 0px',float:'right'}">
    ...
    export default {
       ...
       components: {
        ...
        data () {
            return {
                charts: '',
                opinion:['90分——100分','80分——89分','70分——79分','60分——69分','60分以下'],
                opinionData:[
