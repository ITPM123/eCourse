...
public class FileUtil {
     ...
     * @return
     */
    public static ResultEntity uploadSingleFile(MultipartFile uploadFile, String sub_dir, Set<String> allow_file_exts){
        File path = PathUtil.getSaveDir(sub_dir);
        if (path==null)
    ...
    public static ResultEntity uploadSingleFileForExcel(MultipartFile uploadFile, String sub_dir){
    ...
    public static ResultEntity uploadSingleFile(MultipartFile uploadFile, String sub_dir){
