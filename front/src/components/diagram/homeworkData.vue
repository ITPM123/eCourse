...
<div :style="{ background: '#fff', padding: '0px',width:'600px',height:'600px',margin: '0px 0px 0px 0px',float:'left'}">
...
<div :style="{ background: '#fff', padding: '0px',width:'600px',height:'600px',margin: '0px 5px 0px 0px',float:'right'}">
