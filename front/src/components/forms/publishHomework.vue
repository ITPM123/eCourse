<template>
   <a-layout-content :style="{ margin: '24px 16px', padding: '24px', background: '#fff', minHeight: '280px' }">
      ...
      <div :style="{ margin: '20px 10px 25px 10px'}">作业标题：
      ...
      <div :style="{ margin: '20px 10px 25px 10px'}">作业内容：
         ...
         <div :style="{ margin: '10px 10px 25px 10px'}">作业附件：
           <a-upload action="/homework/getCourseHomeworkList" :fileList="fileList"  :remove="handleRemove" :beforeUpload="beforeUpload">
                 <a>选择文件</a>
           </a-upload>
        ...
        <a class="upload-demo-start" type="primary"
         ...
         <div :style="{ margin: '10px 10px 25px 10px'}">选择班级：
              <a-select mode="multiple" :defaultValue="['一班']" style="width: 20%" @change="handleChange" placeholder="选择班级" :style="{ margin: '20px 0px 25px 0px'}">
