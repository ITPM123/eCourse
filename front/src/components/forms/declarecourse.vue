        ...
        <a-card title="课程信息" class="card">
                ...
                <div style="display:flex;flex-direction:column;width:70%">
                    ...
                    <div>
                        <div class="part">
                            ...
                            <a-textarea placeholder="请输入课程概述.." v-model="overview" :autosize="{minRows:4,maxRows:6}"></a-textarea>
                        </div>
                    </div>
                </div>
                <!--头像list-->
            ...
            <div >
                <div class="part">
                    ...
                    <a-textarea placeholder="请输入授课目标" v-model="teaching_goal" :autosize="{minRows:4,maxRows:6}"></a-textarea>
                </div>
            </div>
