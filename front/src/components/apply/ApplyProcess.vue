<template>
  <div>
    <div style="font-weight:bold;font-size:2em;margin-top:20px;margin-left:20px">申报信息填写</div>
    <!--申报人信息-->
    ...
    <a-card title="课程信息" class="card">
        ...
        <div style="display:felx;flex-direction:column;width:70vh">
          <div class="block">
            <div class="part">
              ...
              <a-input style="width:70vh" v-model="courseInfo.name" placeholder="请输入课程名称.."></a-input>
            </div>
          </div>
          <div>
            <div class="part">
      ...
      <div>
        <div class="part">
          ...
          <a-textarea
            placeholder="请输入授课目标"
            v-model="courseInfo.target"
            :autosize="{minRows:4,maxRows:6}"
          ></a-textarea>
        </div>
      </div>
    </a-card>
    <a-button style="margin-left:20px" type="primary" :size="large">提交申报信息</a-button>
  </div>
</template>
